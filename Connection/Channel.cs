...
namespace Connection
{
    ...
    public class Channel
    {
        ...
        {
            CurrentOutGoingQueuedMessage = Encoding.UTF8.GetBytes(message);
        ...
        {
            if (this.MessageType == ChannelMessageTypes.BINARY)
            {
               
            }
            else
            {
                IncomingString.Append(Encoding.UTF8.GetString(socketmessage.GetMessage().ToArray())); // not sure how efficient this is
            }
